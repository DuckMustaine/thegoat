...
class EditorsControllerTest < ActionController::TestCase
  ...
  test "should create editor" do
    assert_difference('Editor.count') do
      post :create, editor: { post: @editor.post, tags: @editor.tags, title: @editor.title, user_id: @editor.user_id }
    end
  ...
  test "should update editor" do
    patch :update, id: @editor, editor: { post: @editor.post, tags: @editor.tags, title: @editor.title, user_id: @editor.user_id }
    assert_redirected_to editor_path(assigns(:editor))
  end
